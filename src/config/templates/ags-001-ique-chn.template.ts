...
const ags001Chn: TemplateDefinition = {
    id: 'ags-001-ique-chn',
    label: 'AGS-iQue (AGS-001)',
    svgPath: 'templates/iQue-AGS-001.svg',
    defaults: {
      serial: 'AB123456789',
      foreground: '#ffffff',
      background: '#231f20',
    ...
    filename: values => `ags-001-ique-chn-${String(values.serial ?? '').toUpperCase()}.svg`,
    fields: [
      {
        id: 'serial',
